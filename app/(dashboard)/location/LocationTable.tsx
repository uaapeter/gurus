...
import { setSelectedLocation } from '@/app/reducers/locationReducer'
...
function LocationTable({ right, locations}: { right: any, locations:any[]}) {
    ...
    return (
        <div className="relative overflow-x-auto py-4">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 bg-white-light">
                ...
                <tbody>
                {
                        locations?.flatMap((item:any, index:number) => {
                            return (
